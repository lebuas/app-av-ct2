...
namespace corte2
{
    public partial class MainWindow : Window
    {
        ...
        async void OnInfoClick(object? sender, RoutedEventArgs e)
        {
            await ShowMessage("Información","Información del aplicativo:\n" +
                                            "Frontend realizado con Framework Avalonia UI (avalonia.net)\n" +
                                            "Creado por(GitHub.com/):\n" +
                                            "JuanCano420\n" +
                                            "lebuas\n" +
                                            "PipeCoding03-COL" +
                                            "\n" +
                                            "Perfil Actors:\n" +
                                            "Botón Buscar: Busca un Actor ingresando el código en el formulario y lo marca en la tabla si lo encuentra\n" +
                                            "Botón Detalle: Devuelve un listado de Series donde trabaja el Actor o Actriz\n" +
                                            "Botón Editar: Habilita la edición en la tabla de Actores\n" +
                                            "Botón Actualizar: Bloquea la edición de la tabla de Actores\n" +
                                            "Botón Adicionar: Permite agregar un Actor o Actriz a la base de datos\n" +
                                            "\n" +
                                            "Perfil Series:\n" +
                                            "Botón Buscar: Busca una Serie en la bd y lo marca en la tabla si lo encuentra, Lo ubica en 1 posición\n" +
                                            "Botón Detalle: Devuelve un listado con los actores que trabaja en la serie\n" +
                                            "Botón Editar: Habilita la edición en la tabla de Series\n" +
                                            "Botón Actualizar: Bloquea la edición en la tabla de Series\n" +
                                            "Botón Adicionar: Permite agregar una Serie a la base de datos\n" +
                                            "Botón Asociar: Permite asociar un Actor o Actriz con una serie\n" +
                                            "Botón Disociar: Permite disociar un Actor de una serie\n" +
                                            "\n" +
                                            "Perfil Github: Lleva al repositorio del proyecto\n" +
                                            "\n" +
                                            "Perfil Salir: Cierra la aplicación\n" +
                                            "\n" +
                                            "Nota: Para eliminar tanto series como actores en las diferentes tablas\n" +
                                            "se usa el boton Rojo de cada registro de datos");
        }
